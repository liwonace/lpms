...
urlpatterns = [
	...
	url(r'^deviceinfo/$', views.deviceinfo, name='sb_admin_deviceinfo'),
	url(r'^inventory/$', views.inventory, name='sb_admin_inventory'),
	url(r'^playbook/$', views.playbook, name='sb_admin_playbook'),
	url(r'^jquery/$', views.jquery, name='sb_jquery'),
]
